...
public class ShoppingCartDTO {
    ...
    public Double getTotalPrice() {
        ...
        for (Map.Entry<Integer, Map<Integer, Double>> shopEntry : shopItemPrices.entrySet()) {
            ...
            if (quantities == null)
                continue; // no quantities for this shop
    ...
    public ShoppingCartDTO getShoppingCartDTOofShop(int shopId) {
        ...
        Map<Integer, List<Integer>> filteredShopItemsMap = Collections.singletonMap(shopId, new ArrayList<>(itemIds));
        Map<Integer, Map<Integer, Double>> filteredPriceMap = Collections.singletonMap(shopId, new HashMap<>(prices));
        Map<Integer, Map<Integer, Integer>> filteredQuantityMap = Collections.singletonMap(shopId,
                new HashMap<>(quantities));
