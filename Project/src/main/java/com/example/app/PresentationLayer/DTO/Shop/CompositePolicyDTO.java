...
public class CompositePolicyDTO {
    ...
    public CompositePolicyDTO getCompoPolicy1() { return compoPolicy1; }
    public void setCompoPolicy1(CompositePolicyDTO compoPolicy1) { this.compoPolicy1 = compoPolicy1; }

    public CompositePolicyDTO getCompoPolicy2() { return compoPolicy2; }
    public void setCompoPolicy2(CompositePolicyDTO compoPolicy2) { this.compoPolicy2 = compoPolicy2; }

    public LeafPolicyDTO getLeafPolicy1() { return leafPolicy1; }
    public void setLeafPolicy1(LeafPolicyDTO leafPolicy1) { this.leafPolicy1 = leafPolicy1; }

    public LeafPolicyDTO getLeafPolicy2() { return leafPolicy2; }
    public void setLeafPolicy2(LeafPolicyDTO leafPolicy2) { this.leafPolicy2 = leafPolicy2; }
    ...
    public String toString() {
     ...
     public static CompositePolicyDTO fromDomain(Policy p) {
        ...
        if (p instanceof PolicyLeaf lf) {
            ...
            LeafPolicyDTO leafDto = new LeafPolicyDTO(lf.getThreshold(), lf.getItemId(), lf.getCategory(), lf.getBasketValue());
