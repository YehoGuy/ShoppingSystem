...
import PresentationLayer.DTO.Role.RoleDTO;
...
public record MemberDTO(
    ...
    /* -------- Domain ➜ DTO -------- */
    public static MemberDTO fromDomain(DomainLayer.Member m) {
    ...
    public DomainLayer.Member toDomain(String password) {
        // Password supplied by caller (e.g., registration flow)
        DomainLayer.Member m = new DomainLayer.Member(
